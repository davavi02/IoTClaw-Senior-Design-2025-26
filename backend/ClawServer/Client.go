//Straight up copied from: https://github.com/gorilla/websocket/blob/main/examples/chat/client.go
...
var upgrader = websocket.Upgrader{
	...
	/*	CheckOrigin: func(r *http.Request) bool {
		...
		log.Println("Attempted origin: ", origin)
		...
		return strings.HasSuffix(origin, "garlicpos.com")
	}, */
}
...
func (c *Client) readPump() {
	...
	for {
		packetType, message, err := c.conn.ReadMessage()
		if err != nil {
...
func (c *Client) writePump() {
	...
	for {
		...
		case message, ok := <-c.send:
			...
			w, err := c.conn.NextWriter(message.PacketType)
			if err != nil {
				return
			}
